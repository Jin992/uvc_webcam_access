...
static void dump_videocontrol_interface(const unsigned char *buf, struct v4l2hw* info)
{
...
static void dump_altsetting(const struct libusb_interface_descriptor *interface, struct v4l2hw* info)
{
...
static void dumpdev(libusb_device *dev, struct v4l2hw* info)
{
